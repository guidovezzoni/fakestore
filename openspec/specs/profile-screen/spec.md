...
This capability defines the Profile screen, which displays the authenticated user's name, email, and favourite count. It covers the MVI state/intent/effect contracts, ViewModel logic, composable rendering, and localised string resources.
