# Spec: Analytics Client

## Purpose

Defines the requirements for the analytics abstraction layer in `:core`, including the `AnalyticsProvider` interface, the `AnalyticsClient` dispatcher, and the `DebugAnalyticsProvider` implementation.
